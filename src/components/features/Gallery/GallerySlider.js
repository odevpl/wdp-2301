  ...
  return (
    <div className={styles.root}>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${process.env.PUBLIC_URL}/images/gallery/aenean-ru-bristique-1.jpeg)`,
      ...
      <div className={'row no-gutters ' + styles.sliderList}>
        ...
        {topSellers.slice(0, 6).map(item => (
          <div
            ...
            key={item.id}
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/images/gallery/${item.id}.jpeg)`,
              backgroundSize: 'cover',
            }}
          ></div>
        ))}
